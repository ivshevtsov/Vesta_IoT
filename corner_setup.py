...
File_main = 'corners_main_lpf'
File_tune = 'corners_tune_lpf'
...
#wb = load_workbook(f'{HOME}/{File_main}.xlsx')
...
sheet.cell(row=5, column=1).value = 'B3'
sheet.cell(row=6, column=1).value = 'B2'
sheet.cell(row=7, column=1).value = 'B1'
sheet.cell(row=8, column=1).value = 'B0'

sheet.cell(row=9, column=1).value = f'{MODEL_FILE}'
sheet.cell(row=10, column=1).value = f'{MODEL_FILE}'
sheet.cell(row=11, column=1).value = f'{MODEL_FILE}'

sheet.cell(row=12, column=1).value = f'{TEST}'
...
for i in range(len(PEX_DATA)-2):
    ...
    sheet.cell(row=9, column=i + 2).value = 't '+PEX_DATA[i + 2][4]
    sheet.cell(row=10, column=i + 2).value ='t '+PEX_DATA[i + 2][5]
    sheet.cell(row=11, column=i + 2).value ='t '+PEX_DATA[i + 2][6]
    sheet.cell(row=12, column=i + 2).value = 't'
